...
class MainActivity : BaseActivity(), NavigationView.OnNavigationItemSelectedListener {
    ...
    private lateinit var holding: ItemRecyclerMainBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        holding = ItemRecyclerMainBinding.inflate(layoutInflater)
...
//        }
    ...
    //TODO : check this
    fun setUsage(content: String?) {
        adapter.txtUpdate = findViewById(R.id.tv_usages)
        adapter.txtUpdate.text = "$content"
        println("--------------------------")
        println("${adapter.txtUpdate.text}/")
        println("--------------------------")
    }
...
//    }
    ...
    fun showMessage(message: String) {
        // Show the modal message box using a dialog or any other UI component
